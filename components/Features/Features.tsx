  ...
  const features = [
    {
      ...
      content: `
        ...
        Go from tracking proress at the milestone level all the way
    ...
    },
    {
      ...
      content: `
        ...
        Our customisable dashboard helps you build out the reports you need to keep
        key shareholders informed.
      `,
    },
    {
      number: '04',
